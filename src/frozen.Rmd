...
ta_time <- 
  ...
  sapply(readxl::read_excel, simplify = FALSE, 
         col_types =
           c("guess", "guess", "guess", "guess", "text", "guess", "guess", 
...
# load raw turnaround time data
# ta_time_Q <- readxl::read_excel(here("data", "2020q3-tat.xls"),
#   col_types =
#     c(
#       "guess",
#       "guess",
...
ta_time %>%
  filter(cl_grp == params$cl_grp, period == params$period) %>% 
  mutate(
